// <copyright file="WiModExtensions.cs" company="Poul Erik Venø Hansen">
...
{
    /// <summary>
    /// Extensions methods used for WiMOD (iMST) products.
    /// </summary>
    public static class WiModExtensions
    {
